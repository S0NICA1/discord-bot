...
SAUDI_ROAST_FALLBACKS = [
    "يا رجال النت عندي يفصل والذكاء الاصطناعي أخذ قيلولة من كثر ما راسي صدع منكم!",
    "سيرفرات قوقل جاها شلل نصفي من سواليفكم.. اركد شوي وراجعين نجلدك!",
    "يا ساتر! حتى السيرفر ما قدر يتحمل الكيس حقك وطفى.. اصبر دقيقة نصلح الوضع!",
    "مستر ذبات راح يتقهوى.. معالج قوقل ذاب من كثر التفكير في ذبة تليق بمقامك النكبة!",
    "سيرفرات الذكاء الاصطناعي معلقة، بس تطمن.. ملف سوابقك محفوظ وراجعين لك بأقوى قصف!"
]
